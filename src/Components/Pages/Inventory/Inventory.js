...
const rows = [
    { id: 1, image: bundleprod, productname: "Product name", status: "Active", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 2, image: bundleprod, productname: "Product name", status: "Inactive", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 3, image: bundleprod, productname: "Product name", status: "Active", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 4, image: bundleprod, productname: "Product name", status: "Inactive", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 5, image: bundleprod, productname: "Product name", status: "Active", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 6, image: bundleprod, productname: "Product name", status: "Inactive", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 7, image: bundleprod, productname: "Product name", status: "Active", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 8, image: bundleprod, productname: "Product name", status: "Inactive", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
    { id: 9, image: bundleprod, productname: "Product name", status: "Active", inventory: "in stock for 4 variants", type: "TOYS", brands: "Digimon", action: "" },
...
export default function Inventory() {
    ...
    const [columns, setcolumns] = useState([
        ...
        { field: 'productname', headerName: 'Product name', renderCell: (params) => <Button component={Link} to="/products/edit-product" color="primary">{params.value}</Button>, flex: 1, sortable: false, },
        {
